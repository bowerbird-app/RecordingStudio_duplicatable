...
- explicit `recording_studio_accessible` wiring for access models and `AccessCheck`
...
- `/guides/setup` - how to install Recording Studio Accessible, run its migrations, mount the engine, provide the current actor, and opt a recordable into duplication
